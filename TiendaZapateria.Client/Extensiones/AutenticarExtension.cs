...
namespace BlazorLogin.Client.Extensiones
{
	public class AutenticacionExtension : AuthenticationStateProvider
	{
		...
		public async Task ActualizarEstadoAutenticacion(AutorizacionResponse? sesionUsuario)
		{
			...
			if (sesionUsuario != null)
			{
				claimsPrincipal = new ClaimsPrincipal(new ClaimsIdentity(new List<Claim>
				{
                    ...
                    new Claim(ClaimTypes.Role,sesionUsuario.nombreRol),
				}, "JwtAuth"));
		...
		public override async Task<AuthenticationState> GetAuthenticationStateAsync()
		{
			...
			var sesionUsuario = await _sessionStorage.ObtenerStorage<AutorizacionResponse>("sesionUsuario");
